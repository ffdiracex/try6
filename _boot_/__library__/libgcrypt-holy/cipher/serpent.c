...
holy_MOD_INIT(gcry_serpent)
{
  holy_cipher_register (&_gcry_cipher_spec_serpent128);
  holy_cipher_register (&_gcry_cipher_spec_serpent192);
  holy_cipher_register (&_gcry_cipher_spec_serpent256);
}

holy_MOD_FINI(gcry_serpent)
{
  holy_cipher_unregister (&_gcry_cipher_spec_serpent128);
  holy_cipher_unregister (&_gcry_cipher_spec_serpent192);
  holy_cipher_unregister (&_gcry_cipher_spec_serpent256);
}

...
holy_MOD_INIT(gcry_des)
{
  holy_cipher_register (&_gcry_cipher_spec_des);
  holy_cipher_register (&_gcry_cipher_spec_tripledes);
}

holy_MOD_FINI(gcry_des)
{
  holy_cipher_unregister (&_gcry_cipher_spec_des);
  holy_cipher_unregister (&_gcry_cipher_spec_tripledes);
}

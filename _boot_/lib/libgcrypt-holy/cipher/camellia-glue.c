...
holy_MOD_INIT(gcry_camellia)
{
  holy_cipher_register (&_gcry_cipher_spec_camellia128);
  holy_cipher_register (&_gcry_cipher_spec_camellia192);
  holy_cipher_register (&_gcry_cipher_spec_camellia256);
}

holy_MOD_FINI(gcry_camellia)
{
  holy_cipher_unregister (&_gcry_cipher_spec_camellia128);
  holy_cipher_unregister (&_gcry_cipher_spec_camellia192);
  holy_cipher_unregister (&_gcry_cipher_spec_camellia256);
}

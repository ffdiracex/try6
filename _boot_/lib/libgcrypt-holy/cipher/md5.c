...
holy_MOD_INIT(gcry_md5)
{
  COMPILE_TIME_ASSERT(sizeof (MD5_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  holy_md_register (&_gcry_digest_spec_md5);
}

holy_MOD_FINI(gcry_md5)
{
  holy_md_unregister (&_gcry_digest_spec_md5);
}

...
holy_MOD_INIT(gcry_crc)
{
  COMPILE_TIME_ASSERT(sizeof (CRC_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  COMPILE_TIME_ASSERT(sizeof (CRC_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  COMPILE_TIME_ASSERT(sizeof (CRC_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  holy_md_register (&_gcry_digest_spec_crc32);
  holy_md_register (&_gcry_digest_spec_crc32_rfc1510);
  holy_md_register (&_gcry_digest_spec_crc24_rfc2440);
}

holy_MOD_FINI(gcry_crc)
{
  holy_md_unregister (&_gcry_digest_spec_crc32);
  holy_md_unregister (&_gcry_digest_spec_crc32_rfc1510);
  holy_md_unregister (&_gcry_digest_spec_crc24_rfc2440);
}

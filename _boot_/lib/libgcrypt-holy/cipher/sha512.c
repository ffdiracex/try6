...
holy_MOD_INIT(gcry_sha512)
{
  COMPILE_TIME_ASSERT(sizeof (SHA512_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  COMPILE_TIME_ASSERT(sizeof (SHA512_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  holy_md_register (&_gcry_digest_spec_sha512);
  holy_md_register (&_gcry_digest_spec_sha384);
}

holy_MOD_FINI(gcry_sha512)
{
  holy_md_unregister (&_gcry_digest_spec_sha512);
  holy_md_unregister (&_gcry_digest_spec_sha384);
}

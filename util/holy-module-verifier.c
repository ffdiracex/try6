...
struct holy_module_verifier_arch archs[] = {
  { "i386", 4, 0, EM_386, holy_MODULE_VERIFY_SUPPORTS_REL, (int[]){
      R_386_32,
      R_386_PC32,
      -1
    } },
  { "x86_64", 8, 0, EM_X86_64, holy_MODULE_VERIFY_SUPPORTS_RELA, (int[]){
      R_X86_64_64,
      R_X86_64_PC64,
  ...
  { "powerpc", 4, 1, EM_PPC, holy_MODULE_VERIFY_SUPPORTS_RELA, (int[]){
      holy_ELF_R_PPC_ADDR16_LO,
      holy_ELF_R_PPC_REL24, /* It has limited range but holy adds trampolines when necessarry.  */
      holy_ELF_R_PPC_ADDR16_HA,
      holy_ELF_R_PPC_ADDR32,
      holy_ELF_R_PPC_REL32,
      -1
    } },
  { "sparc64", 8, 1, EM_SPARCV9, holy_MODULE_VERIFY_SUPPORTS_RELA, (int[]){
      R_SPARC_WDISP30, /* It has limited range but holy adds trampolines when necessarry. */
      R_SPARC_HH22,
      R_SPARC_HM10,
      R_SPARC_LM22,
      R_SPARC_LO10,
  ...
  { "ia64", 8, 0, EM_IA_64, holy_MODULE_VERIFY_SUPPORTS_RELA, (int[]){
  ...
  { "mipsel", 4, 0, EM_MIPS, holy_MODULE_VERIFY_SUPPORTS_REL | holy_MODULE_VERIFY_SUPPORTS_RELA, (int[]){
      R_MIPS_HI16,
      R_MIPS_LO16,
      R_MIPS_32,
      R_MIPS_GPREL32,
  ...
  { "mips", 4, 1, EM_MIPS, holy_MODULE_VERIFY_SUPPORTS_REL | holy_MODULE_VERIFY_SUPPORTS_RELA, (int[]){
      R_MIPS_HI16,
      R_MIPS_LO16,
      R_MIPS_32,
      R_MIPS_GPREL32,
  ...
  { "arm", 4, 0, EM_ARM, holy_MODULE_VERIFY_SUPPORTS_REL, (int[]){
  ...
  { "arm64", 8, 0, EM_AARCH64, holy_MODULE_VERIFY_SUPPORTS_REL | holy_MODULE_VERIFY_SUPPORTS_RELA, (int[]){
      R_AARCH64_ABS64,
      R_AARCH64_CALL26,
      R_AARCH64_JUMP26,
...
main (int argc, char **argv)
{
  ...
  if (arch == ARRAY_SIZE(archs))
    holy_util_error("unknown arch: %s", argv[2]);
  ...
  module_size = holy_util_get_image_size (argv[1]);
  module_img = holy_util_read_image (argv[1]);
  if (archs[arch].voidp_sizeof == 8)
    holy_module_verify64(module_img, module_size, &archs[arch], whitelist_empty);
  else
    holy_module_verify32(module_img, module_size, &archs[arch], whitelist_empty);
  return 0;
}

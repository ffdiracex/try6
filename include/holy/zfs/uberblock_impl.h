...
typedef struct uberblock {
	holy_uint64_t	ub_magic;	/* UBERBLOCK_MAGIC		*/
	holy_uint64_t	ub_version;	/* ZFS_VERSION			*/
	holy_uint64_t	ub_txg;		/* txg of last sync		*/
	holy_uint64_t	ub_guid_sum;	/* sum of all vdev guids	*/
	holy_uint64_t	ub_timestamp;	/* UTC time of last sync	*/

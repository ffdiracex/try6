...
#define holy_RADEON_FULOONG2E_TOTAL_MEMORY_SPACE 1048576
...
static holy_err_t
holy_video_radeon_fuloong2e_video_init (void)
{
  /* Reset frame buffer.  */
...
static holy_err_t
holy_video_radeon_fuloong2e_video_fini (void)
{
  if (framebuffer.mapped)
    holy_pci_device_unmap_range (framebuffer.dev, framebuffer.ptr,
				 holy_RADEON_FULOONG2E_TOTAL_MEMORY_SPACE);

  return holy_video_fb_fini ();
}

#ifndef TEST
/* Helper for holy_video_radeon_fuloong2e_setup.  */
static int
...
static holy_err_t
holy_video_radeon_fuloong2e_setup (unsigned int width, unsigned int height,
			unsigned int mode_type, unsigned int mode_mask __attribute__ ((unused)))
{
...
#ifndef TEST
  framebuffer.ptr
    = (void *) holy_pci_device_map_range (framebuffer.dev,
					  framebuffer.base,
					  holy_RADEON_FULOONG2E_TOTAL_MEMORY_SPACE);
#endif
  ...
  holy_memset (framebuffer.ptr, 0x55,
...
static holy_err_t
holy_video_radeon_fuloong2e_swap_buffers (void)
{
...
static holy_err_t
holy_video_radeon_fuloong2e_set_active_render_target (struct holy_video_render_target *target)
{
...
static holy_err_t
holy_video_radeon_fuloong2e_get_info_and_fini (struct holy_video_mode_info *mode_info,
				    void **framebuf)
{
...
static struct holy_video_adapter holy_video_radeon_fuloong2e_adapter =
  {
    .name = "RADEON RV100 QZ (Fuloong2E) Video Driver",
    .id = holy_VIDEO_DRIVER_RADEON_FULOONG2E,

    .prio = holy_VIDEO_ADAPTER_PRIO_NATIVE,

    .init = holy_video_radeon_fuloong2e_video_init,
    .fini = holy_video_radeon_fuloong2e_video_fini,
    .setup = holy_video_radeon_fuloong2e_setup,
    .get_info = holy_video_fb_get_info,
    .get_info_and_fini = holy_video_radeon_fuloong2e_get_info_and_fini,
    ...
    .swap_buffers = holy_video_radeon_fuloong2e_swap_buffers,
    .create_render_target = holy_video_fb_create_render_target,
    .delete_render_target = holy_video_fb_delete_render_target,
    .set_active_render_target = holy_video_radeon_fuloong2e_set_active_render_target,
    .get_active_render_target = holy_video_fb_get_active_render_target,

    .next = 0
  };

holy_MOD_INIT(video_radeon_fuloong2e)
{
  holy_video_register (&holy_video_radeon_fuloong2e_adapter);
}

holy_MOD_FINI(video_radeon_fuloong2e)
{
  holy_video_unregister (&holy_video_radeon_fuloong2e_adapter);
}

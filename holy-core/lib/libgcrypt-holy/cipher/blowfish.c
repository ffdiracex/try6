...
holy_MOD_INIT(gcry_blowfish)
{
  holy_cipher_register (&_gcry_cipher_spec_blowfish);
}

holy_MOD_FINI(gcry_blowfish)
{
  holy_cipher_unregister (&_gcry_cipher_spec_blowfish);
}

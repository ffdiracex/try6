...
holy_MOD_INIT(gcry_tiger)
{
  COMPILE_TIME_ASSERT(sizeof (TIGER_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  COMPILE_TIME_ASSERT(sizeof (TIGER_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  COMPILE_TIME_ASSERT(sizeof (TIGER_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  holy_md_register (&_gcry_digest_spec_tiger);
  holy_md_register (&_gcry_digest_spec_tiger1);
  holy_md_register (&_gcry_digest_spec_tiger2);
}

holy_MOD_FINI(gcry_tiger)
{
  holy_md_unregister (&_gcry_digest_spec_tiger);
  holy_md_unregister (&_gcry_digest_spec_tiger1);
  holy_md_unregister (&_gcry_digest_spec_tiger2);
}

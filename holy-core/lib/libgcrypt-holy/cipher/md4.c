...
holy_MOD_INIT(gcry_md4)
{
  COMPILE_TIME_ASSERT(sizeof (MD4_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  holy_md_register (&_gcry_digest_spec_md4);
}

holy_MOD_FINI(gcry_md4)
{
  holy_md_unregister (&_gcry_digest_spec_md4);
}

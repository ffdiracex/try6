...
holy_MOD_INIT(gcry_sha1)
{
  COMPILE_TIME_ASSERT(sizeof (SHA1_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  holy_md_register (&_gcry_digest_spec_sha1);
}

holy_MOD_FINI(gcry_sha1)
{
  holy_md_unregister (&_gcry_digest_spec_sha1);
}

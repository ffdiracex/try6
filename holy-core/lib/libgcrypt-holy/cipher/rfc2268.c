...
holy_MOD_INIT(gcry_rfc2268)
{
  holy_cipher_register (&_gcry_cipher_spec_rfc2268_40);
}

holy_MOD_FINI(gcry_rfc2268)
{
  holy_cipher_unregister (&_gcry_cipher_spec_rfc2268_40);
}

...
holy_MOD_INIT(gcry_rmd160)
{
  COMPILE_TIME_ASSERT(sizeof (RMD160_CONTEXT) <= holy_CRYPTO_MAX_MD_CONTEXT_SIZE);
  holy_md_register (&_gcry_digest_spec_rmd160);
}

holy_MOD_FINI(gcry_rmd160)
{
  holy_md_unregister (&_gcry_digest_spec_rmd160);
}

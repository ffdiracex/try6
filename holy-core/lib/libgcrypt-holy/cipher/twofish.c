...
holy_MOD_INIT(gcry_twofish)
{
  holy_cipher_register (&_gcry_cipher_spec_twofish);
  holy_cipher_register (&_gcry_cipher_spec_twofish128);
}

holy_MOD_FINI(gcry_twofish)
{
  holy_cipher_unregister (&_gcry_cipher_spec_twofish);
  holy_cipher_unregister (&_gcry_cipher_spec_twofish128);
}
